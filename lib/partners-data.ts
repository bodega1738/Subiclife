...
export const allOffers: Offer[] = [
  // Lighthouse Marina Resort
  {
    ...
    partnerId: "lighthouse",
    partnerName: "Lighthouse Marina Resort",
    title: "Aqua Veranda Suite - 25% Off Elite",
    description: "Luxury waterfront suite with stunning bay views",
    image: "/luxury-resort-suite-ocean-view-sunset.jpg",
    logo: "/images/subic-sailing-hero.jpg",
    discount: 25,
    isEliteExclusive: true,
  ...
  },
  {
    ...
    description: "Fine dining with breathtaking sunset views",
    image: "/luxury-resort-suite-ocean-view-sunset.jpg",
    logo: "/images/subic-sailing-hero.jpg",
    discount: 20,
    originalPrice: 3500,
  ...
  // La Banca Cruises
  {
    ...
    partnerId: "labanca",
    partnerName: "La Banca Cruises",
    title: "FREE 3-Hour Cruise (Elite)",
    description: "Luxury yacht cruise around Subic Bay",
    image: "/luxury-yacht-cruise-sunset-subic-bay.jpg",
    logo: "/images/la-banca-cruises-logo.png",
    discount: 100,
    isEliteExclusive: true,
  ...
  },
  {
    ...
    description: "Romantic sunset cruise with champagne",
    image: "/luxury-yacht-cruise-sunset-subic-bay.jpg",
    logo: "/images/la-banca-cruises-logo.png",
    discount: 20,
    originalPrice: 12000,
  ...
  // Zoobic Safari
  {
    ...
    partnerName: "Zoobic Safari",
    title: "Night Safari Experience",
    description: "Thrilling nighttime wildlife adventure",
    image: "/tiger-safari-night-dark-dramatic.jpg",
    logo: "/images/zoobic-safari-logo.jpeg",
    discount: 25,
    isEliteExclusive: true,
  ...
  },
  {
    ...
    description: "Up-close tiger feeding experience",
    image: "/tiger-safari-night-dark-dramatic.jpg",
    logo: "/images/zoobic-safari-logo.jpeg",
    discount: 20,
    originalPrice: 1500,
  ...
  // Tree Top Adventure
  {
    ...
    partnerName: "Tree Top Adventure",
    title: "Canopy Tour Package",
    description: "Explore the forest from above",
    image: "/zipline-forest-canopy-adventure-green.jpg",
    logo: "/images/tree-top-adventure-logo.jpeg",
    discount: 20,
    originalPrice: 2500,
  ...
  },
  {
    ...
    description: "Feel like a superhero on this thrilling ride",
    image: "/zipline-forest-canopy-adventure-green.jpg",
    logo: "/images/tree-top-adventure-logo.jpeg",
    discount: 20,
    originalPrice: 1800,
  ...
  // Funtastic Park
  {
    ...
    description: "Unlimited access to all rides and attractions",
    image: "/images/funtastic-park-logo.jpeg",
    logo: "/images/funtastic-park-logo.jpeg",
    discount: 20,
    originalPrice: 1200,
  ...
  },
  {
    ...
    partnerName: "Funtastic Park",
    title: "VIP Fast Pass",
    description: "Skip the lines with exclusive VIP access",
    image: "/images/funtastic-park-logo.jpeg",
    logo: "/images/funtastic-park-logo.jpeg",
    discount: 20,
    isEliteExclusive: true,
  ...
  },
  {
    ...
    description: "Soar above Subic Bay",
    image: "/jet-ski-ocean-watersports-blue-sky.jpg",
    logo: "/images/king-of-watersports.jpg",
    discount: 20,
    isEliteExclusive: true,
  ...
  // ICC Zambales
  {
    ...
    description: "Explore local culture and sustainable tourism",
    image: "/subic-bay-aerial-view-blue-ocean-tropical.jpg",
    logo: "/images/icc-zambales-logo.png",
    discount: 20,
    originalPrice: 800,
  ...
  // Standard Insurance
  {
    ...
    description: "Comprehensive travel insurance protection",
    image: "/images/standard-insurance-logo.png",
    logo: "/images/standard-insurance-logo.png",
    discount: 0,
    originalPrice: 5000,
  ...
  // Assist America
  {
    ...
    description: "Global emergency assistance services",
    image: "/images/assist-america-logo.jpg",
    logo: "/images/assist-america-logo.jpg",
    discount: 0,
    originalPrice: 3000,
