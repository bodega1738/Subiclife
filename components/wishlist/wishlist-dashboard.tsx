...
import { partners, featuredOffers } from "@/lib/partners-data"
  ...
  const filteredOffers = featuredOffers
    ...
    .map((offer) => {
      ...
      return {
        ...offer,
        logo: partner?.logo,
        image: offer.image || partner?.image,
        ...
        <div className="px-6 pt-14 pb-8">
          <div className="flex items-center justify-between mb-8">
            <button 
              ...
              className="w-12 h-12 rounded-full bg-white dark:bg-input-dark shadow-premium border border-gray-100 flex items-center justify-center hover:bg-gray-50 transition-all active:scale-95"
            >
        ...
        <div className="px-6">
          {filteredOffers.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
              <div className="w-24 h-24 rounded-full bg-gray-50 flex items-center justify-center mb-6 shadow-premium">
              ...
              <Link 
                href="/home" 
                className="bg-[#135bec] text-white font-bold py-4 px-10 rounded-full shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all active:scale-95"
              >
                Explore Offers
              </Link>
            </div>
